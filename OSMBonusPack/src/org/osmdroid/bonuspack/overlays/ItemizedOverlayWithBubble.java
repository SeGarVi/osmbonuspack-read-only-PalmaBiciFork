...
public class ItemizedOverlayWithBubble<Item extends OverlayItem> extends ItemizedIconOverlay<Item> {
	...
	public ItemizedOverlayWithBubble(final Context context, 
			final List<Item> aList, final MapView mapView, final InfoWindow bubble) {
	...
	public ItemizedOverlayWithBubble(final Context context, final Drawable defaultMarker, 
			final List<Item> aList, final MapView mapView, final InfoWindow bubble) {
		super(aList, defaultMarker, new OnItemGestureListener<Item>() {
	            @Override public boolean onItemSingleTapUp(final int index, final OverlayItem item) {
	                return false;
	        }
	        @Override public boolean onItemLongPress(final int index, final OverlayItem item) {
	...
	public ItemizedOverlayWithBubble(final Context context, final Drawable defaultMarker, final List<Item> aList, 
			final MapView mapView) {
		this(context,defaultMarker, aList, mapView, null);
	}
